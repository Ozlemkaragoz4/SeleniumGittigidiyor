...
public class TestCases extends BaseTest{
    ...
    public void test_1_3_Logged_in() throws InterruptedException {
        element(username).sendKeys("oz.karagsgv@gmail.com");
        element(password).sendKeys("1234abc.");
        Thread.sleep(3000);
        element(giris).click();
    ...
    public void test_1_5_secondPage() throws InterruptedException {
        ...
        //element(banner).click(); Çalışmam sırasında 24-25 eylül  indirimleri hakkında banner vardı.
